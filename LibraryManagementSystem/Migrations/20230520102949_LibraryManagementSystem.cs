...
namespace LibraryManagementSystem.Migrations
{
    ...
    public partial class LibraryManagementSystem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Returning_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Borrowing_ID = table.Column<int>(type: "int", nullable: false),
                    Returning_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    Lost_book = table.Column<bool>(type: "bit", nullable: true),
                    Date_created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Date_updated = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Returning", x => x.Returning_ID);
                    table.ForeignKey(
                        name: "FK_Returning_Borrowing_Borrowing_ID",
                        column: x => x.Borrowing_ID,
                        principalTable: "Borrowing",
                        principalColumn: "Borrowing_ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Returning_Borrowing_ID",
                table: "Returning",
                column: "Borrowing_ID");
        }
